...
//=============================================================================
 /*:
 * @plugindesc Face Chat System / Skit System
 * @author Naoya （http://respawnfromhere.blog.fc2.com/）
 *
 * @param x
 * @desc x coordinate where face chat notification window displayed
 * @default 0
 *
 * @param y
 * @desc y coordinate where face chat notification window displayed
 * @default 550
 *
 * @param width
 * @desc width of face chat notification window
 * @default 410
 *
 * @param type
 * @desc window types for face chat notification window
 * 0：default 1：dim 2:none
 * @default 1
 *
 * @param IconNumber
 * @desc icon for face chat notification window
 *  0 is specified, for unused icon uses letter [C] instead.
 * @default 4
 *
 * @param [C]color
 * @desc [C] text color for system
 * Won't be used if icon is used.
 * @default 2
 *
 * @param MsgWindowHeight
 * @desc height of the message window used for layout calculations.
 *　If it's blank, the height is automatically obtained and calculated.
 * @default
 *
 * @param ChangeTone
 * @desc FaceChat Ready whether color tone should be used
 * true:used (dark tint) false:unused (no tint)
 * @default true
 *
 * @help
 *
 ...
 * //=============================================================================
 *
 * Implements face chat system
 * Function １： Allows any common event to be called from the map.
 * Function ２： When editing a common event, you can use a plugin command
 *        to start a facechat.
 *
 * Please create your event by referring to the following website and included event from the demo.
 * If you have any questions, please feel free to contact us through our blog or Twitter.
 *
 * ・ Reference guide
 ...
 * 【Update log】
 *  ○ Ver 1.01 （2015/11/21）
 *   ・Fixed a window when chat is empty
 *  ○ Ver 1.02 （2015/11/21）
 *   ・Fixed layout issue when window margin was created
 *  ○ Ver 1.10 (2015/11/26)
 *   ・Added function for balloon
 *   ・Added function for state
 *   ・Possible to change face graphic
 *   ・Movement for face graphic
 *   ・Support for gamepad
 *   ・Fixed an issue where added chats disappear after restarting
 *  ○ Ver 1.11 (2015/12/10)
 *   ・Fixed balloon and state icon rendering
 *   ・for FaceChat Ready
 *     Fixed a problem where the opening of the title window was momentarily visible.
 *   ・for FaceChat ChangeFace
 *   ・Added measures to prevent conflicts with other plugins
 *  ○ Ver 1.12 (2015/12/31)
 *   ・Condense operation
 *  ○ Ver 1.13 (2016/1/2)
 ...
 *  ○ Ver 1.14 (2016/1/3)
 *   ・for FaceChat Ready
 *     Added plugin parameter for color tone
 *   ・Fixed a bug that prevented chat activation from working correctly when testing
 *  ○ Ver 1.15 (2016/1/23)
 *   ・Fixed several issues
 *  ○ Ver 1.20 (2016/2/24)
 *   ・Implemented startup by click (touch) Slightly lighter operation
 *  ○ Ver 1.21 (2016/3/22)
 *   ・Fixed a problem that an error occurs when loading data saved when the plugin is off/ on.
 *  ○ Ver 1.22 (2016/7/28)
 *   ・Fixed title window not to open when common event is executed directly.
 *
 */
 //=============================================================================
